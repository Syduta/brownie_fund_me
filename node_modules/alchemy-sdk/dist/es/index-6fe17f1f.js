...
var TransactionJobStatus;
(function (TransactionJobStatus) {
    TransactionJobStatus["UNSPECIFIED"] = "TRANSACTION_JOB_STATUS_UNSPECIFIED";
    TransactionJobStatus["IN_PROGRESS"] = "IN_PROGRESS";
    TransactionJobStatus["COMPLETE"] = "COMPLETE";
    TransactionJobStatus["ABANDONED"] = "ABANDONED";
})(TransactionJobStatus || (TransactionJobStatus = {}));
    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield import('./alchemy-provider-3a21de51.js');
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield import('./alchemy-websocket-provider-2b8ab20b.js');
...
class TransactNamespace {
     ...
     */
    // @ts-ignore - Temporary private class until next release.
    getTransactionJobStatus(transactionJobId) {
        return __awaiter(this, void 0, void 0, function* () {
            const provider = yield this.config.getProvider();
            return provider._send('alchemy_getTransactionStatus', [transactionJobId], 'getTransactionJobStatus');
        });
    }
    _sendGasOptimizedTransaction(signedTransactions, methodName) {
        return __awaiter(this, void 0, void 0, function* () {
            const provider = yield this.config.getProvider();
            return provider._send('alchemy_sendRawTransaction', [
                {
